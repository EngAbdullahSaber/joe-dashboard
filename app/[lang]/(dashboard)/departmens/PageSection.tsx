...
const PageSection = () => {
  ...
  const getData = async () => {
    try {
      const res = await getSpecifiedPageMeta(lang, "department");
            ...
            <CreateButtonSection
              ...
              onCreate={async (data, lang, pageId) => {
                try {
                  ...
                  const payload: any = {
                    id: "secDepartment" + data["position"],
                    type: data["type"],
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Type: {section.type} | Position: {section.position} |
                        Status: {section.visible ? "Visible" : "Hidden"}
                      </p>
                    </div>
                    ...
                    {section.image && (
                      <div>
                        ...
                        <div className="flex flex-col space-y-2">
                          ...
                          />
                          <p className="text-sm text-gray-600">
                            <strong>Alt:</strong> {section.image.alt || "-"}
                          </p>
                        </div>
                      </div>
                    )}
